  ...
  [77, 5],
  {
    ...
    AUa1: function (e, t, n) {
      ...
      function ue() {
        ...
        return (
          'hover' === c && (j('mouseenter', y), j('mouseleave', w)),
          'touch' === c && (j(E, y), j(x, w), j(S, w), j(O, w)),
          'focus' === c && (j(E, y), v(w, d.concat(f), E)),
