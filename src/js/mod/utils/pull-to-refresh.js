...
const initPullToRefresh = function (pageContainer, callback) {
    ...
    // Attach Events
    var passiveListener = touchEvents.start === 'touchstart' && support.passiveListener ? {passive: true, capture: false} : false;
    eventsTarget.on(touchEvents.start, handleTouchStart, passiveListener);
    eventsTarget.on(touchEvents.move, handleTouchMove);
    eventsTarget.on(touchEvents.end, handleTouchEnd, passiveListener);
...
const pullToRefreshDone = function (container) {
    container = $(container);
...
const pullToRefreshTrigger = function (container) {
    container = $(container);
...
const destroyPullToRefresh = function (pageContainer) {
...
export {initPullToRefresh, pullToRefreshDone, pullToRefreshTrigger, destroyPullToRefresh}
