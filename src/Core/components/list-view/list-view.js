...
import { WUI_list_header, WUI_list_body, WUI_list_footer } from '../list/styles'
...
export default class ListView extends React.Component {
  ...
  render() {
    ...
    return React.cloneElement(
      ...
      this.props.renderHeader ? this.props.renderHeader(WUI_list_header) : null,
      React.cloneElement(props.renderBodyComponent(), {}, bodyComponents),
      this.props.renderFooter ? this.props.renderFooter(WUI_list_footer) : null,
      props.children
    );
  }
