...
import { Page, Button, Picker, ContentBlock, Form, FormItem, Flex } from '@wonder-ui/core';
...
export default function PickerExamples(props) {
  ...
  const [ data , setData ] = React.useState([
    {
      label: 'a', value: 'a', level: 1, 
      children: [
        {
          label: 'a.c', value: 'aa', level: 2 ,
          children: [
            {label: 'a.c.d', value: 'aabn', level: 3}
          ]
        }
      ]
    },
