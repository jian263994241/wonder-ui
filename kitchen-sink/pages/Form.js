...
export default function FormExamples(props) {
  ...
  return (
    <Page name="Form" navbar>
      <Form ref={formRef} onFinishFailed={handleError} onFinish={submit}>
        <List renderHeader={() => '基本'}>
          ...
          >
            <InputItem placeholder="请输入" multiline>
              多行
            </InputItem>
          </FormItem>
          <FormItem
          ...
          >
            <InputItem extra="元" placeholder="请输入" alignRight type="number">
              数字
            </InputItem>
          </FormItem>
        </List>
        ...
        <List renderHeader={() => `禁用字段`}>
          <InputItem value="不可编辑" readOnly>
            只读
          </InputItem>
          <InputItem value="不可编辑" disabled>
            禁用
          </InputItem>
        </List>
        <Block top={5} blank={1}>
