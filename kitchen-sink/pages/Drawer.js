  ...
  return (
    <Page name="Drawer" navbar>
      <ContentBlock>
        ...
        <FullButton fullWidth onClick={handleOpen.bind(null, 'right')}>
          Anchor Right
        </FullButton>
        <FullButton fullWidth onClick={handleOpen.bind(null, 'left')}>
          Anchor Left
        </FullButton>
        <FullButton fullWidth onClick={handleOpen.bind(null, 'top')}>
          Anchor Top
        </FullButton>
        <FullButton fullWidth onClick={handleOpen.bind(null, 'bottom')}>
          Anchor Bottom
        </FullButton>
      </ContentBlock>
