...
import { Page, Button, ContentBlock, withStyles } from '@wonder-ui/core';
import { ArrowBackIosOutlined, Close } from '@wonder-ui/icons';

const ButtonDemo = withStyles(() => ({
  root: {
  ...
  return (
    <Page name="Button" navbar>
      ...
      <ContentBlock header="round">
        <div>
          <ButtonDemo variant="outlined" size="small" rounded>
            outlined
          </ButtonDemo>
          <ButtonDemo variant="outlined" rounded>
            outlined
          </ButtonDemo>
          <ButtonDemo variant="outlined" size="large" rounded>
            outlined
          </ButtonDemo>
        </div>
        <div>
          <ButtonDemo variant="contained" size="small" rounded>
            contained
          </ButtonDemo>
          <ButtonDemo variant="contained" rounded>
            contained
          </ButtonDemo>
          <ButtonDemo variant="contained" size="large" rounded>
            contained
          </ButtonDemo>
        </div>
      </ContentBlock>
      ...
      <ContentBlock header="color">
        ...
        <div>
          ...
          <ButtonDemo color="primary" variant="outlined">
            primary
          </ButtonDemo>
          <ButtonDemo color="secondary" variant="outlined">
            secondary
          </ButtonDemo>
        </div>
        <div>
          <ButtonDemo variant="text">default</ButtonDemo>
          <ButtonDemo color="primary" variant="text">
            primary
          </ButtonDemo>
          <ButtonDemo color="secondary" variant="text">
            secondary
          </ButtonDemo>
        </div>
      </ContentBlock>
      ...
      <ContentBlock header="disabled">
        ...
        <ButtonDemo disabled variant="text">
          default
        </ButtonDemo>
      </ContentBlock>
    </Page>
